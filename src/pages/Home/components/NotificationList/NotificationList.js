...
import "../NotificationList/NotificationList.css";
      ...
      <div className="container">
        <div class="row">
          <div class="col-12 col-sm-6 p-0">
            ...
            <Link to="/news/notification/detail/5" onClick={scrollToTop}>
              <div className="notification-item">
                ...
                <div>
                  ...
                  <p className="notification-content">
                    ...
                    tiến giai đoạn 2020-2024 và phát động phong trào thi đua
                    giai đoạn 2025-2030.
                  </p>
                </div>
              </div>
          ...
          <div class="col-12 col-sm-6 p-0">
            ...
            <Link to="/news/activity/detail/5" onClick={scrollToTop}>
              <div className="notification-item">
                <img
                  className="notification-img"

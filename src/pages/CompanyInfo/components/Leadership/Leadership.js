...
const leadershipData = [
  {
    ...
    image: bld,
    description: "Ông Lê Tiến Thịnh có hơn 20 năm kinh nghiệm trong lĩnh vực công nghệ thông tin và điều hành doanh nghiệp. Dưới sự lãnh đạo của ông, công ty đã đạt được nhiều thành tựu quan trọng và phát triển vững mạnh.",
    education: "Thạc sĩ Quản trị Kinh doanh",
    experience: [
      "20+ năm kinh nghiệm trong lĩnh vực CNTT",
  ...
  },
  {
    ...
    position: (
      <>
        Kiểm soát viên của Tổng công ty
      </>
    ),
    image: bld,
  },

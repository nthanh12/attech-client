        ...
        <div className="search-header">
          <div className="search-input-container">
            ...
            <input
              ...
              placeholder={
                currentLanguage === "vi"
                  ? "Tìm kiếm tin tức, thông báo, sản phẩm, dịch vụ..."
                  : "Search news, notifications, products, services..."
              }
              value={keyword}
        ...
        <div className="search-content">
          {loading && (
            <div className="search-loading">
              ...
              <span>
                {currentLanguage === "vi" ? "Đang tìm kiếm..." : "Searching..."}
              </span>
            </div>
          )}
          ...
          {!loading && !error && keyword.length < 2 && (
            <div className="search-placeholder">
              ...
              <h3>{currentLanguage === "vi" ? "Tìm kiếm" : "Global Search"}</h3>
              <p>
                {currentLanguage === "vi"
                  ? "Nhập ít nhất 2 ký tự để tìm kiếm thông tin"

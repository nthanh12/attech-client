...
export const ROUTES = {
  ...
  PRODUCT_DETAIL: {
    vi: "/san-pham/:slug.html",
    en: "/en/products/:slug.html",
  },
  ...
  SERVICE_DETAIL: {
    vi: "/dich-vu/:slug.html",
    en: "/en/services/:slug.html",
  },
  ...
  NOTIFICATION_DETAIL: {
    vi: "/thong-bao/:slug.html",
    en: "/en/notifications/:slug.html",
  },
...
export const switchLanguageUrl = (currentPath, targetLang) => {
  ...
  if (!currentRouteKey) {
    ...
    const pathMappings = {
      ...
      "/thong-tin-cong-ty":
        targetLang === "en" ? "/en/company" : "/thong-tin-cong-ty",

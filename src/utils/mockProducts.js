export const mockProducts = [
  {
    id: 1,
    titleVi: "Hệ thống ADS-B",
    slugVi: "he-thong-ads-b",
    titleEn: "ADS-B System",
    slugEn: "ads-b-system",
    descriptionVi:
...
<li>Đồng bộ thời gian với m&aacute;y chủ.</li>
    ...
    status: 1,
    productCategoryId: 1,
    productCategorytitleVi: "CNS/ATM",
    productCategorytitleEn: "CNS/ATM",
  ...
  {
    id: 2,
    titleVi: "Hệ thống luân chuyển điện văn không lưu AMHS",
    slugVi: "he-thong-amhs",
    titleEn: "AMHS - Aeronautical Message Handling System",
    slugEn: "amhs-system",
    descriptionVi:
...
<li>C&oacute; thể cập nhật th&ocirc;ng tin AMHS từ AMC (ATS Management Centre).</li>
  ...
  {
    id: 3,
    titleVi: "Hệ thống chuyển tiếp điện văn tự động AMSS",
...
<li style="padding-left: 30px;">Nhiệt độ trong ph&ograve;ng l&agrave;m việc 22 &plusmn; 2 độ C, độ ẩm dưới 65%.</li>
  ...
  {
    id: 4,
    titleVi: "Đèn chỉ thị góc tiếp cận chính xác - PAPI",
    slugVi: "den-papi",
    titleEn: "Precise Approach Angle Indicator - PAPI",
    slugEn: "papi-light",
    descriptionVi: "",
    descriptionEn:
    ...
    status: 1,
    productCategoryId: 2,
    productCategorytitleVi: "Hệ thống đèn hiệu",
    productCategorytitleEn: "Lighting System",
  ...
  {
    id: 5,
    titleVi: "Đèn lề đường CHC hai hướng lắp nổi",
    slugVi: "den-chc-hai-huong",
    titleEn: "CHC two-way surface mounted curb light",
...
<li>Sử dụng nguồn 6.6A v&agrave; một biến d&ograve;ng c&aacute;ch ly 150W hoặc 200W</li>
  ...
  {
    id: 6,
    titleVi: "Đèn lề đường lăn lắp nổi LED",
    slugVi: "den-le-duong-noi-led",
    titleEn: "Led Road Edge Light",
...
<li>Sử dụng nguồn 6.6A v&agrave; một biến d&ograve;ng c&aacute;ch ly 25W/1.1A</li>
  ...
  {
    id: 7,
    titleVi: "Đèn lề đường lăn lắp nổi",
    slugVi: "den-le-duong-noi",
    titleEn: "Road Edge Light",
...
<li>Chiều cao lắp đặt ph&ugrave; hợp với ti&ecirc;u chuẩn ICAO</li>
  ...
  {
    id: 8,
    titleVi: "Đèn chớp lắp nổi",
    slugVi: "den-chop-lap-noi",
    titleEn: "Unidirectional Elevated Flashing Light",
...
<li>Gi&oacute;: 278 km/h</li>
  ...
  {
    id: 9,
    titleVi: "Đèn pha 1 hướng lắp nổi",
    slugVi: "den-1-pha-lap-noi",
    titleEn: "Unidirectional Light",
...
<li>Sử dụng d&acirc;y 2 cực 2,5mm<sup>2</sup>&nbsp;(hoặc AWG 12) giữa biến d&ograve;ng c&aacute;ch ly v&agrave; đ&egrave;n, nguồn 6.6A v&agrave; một biến d&ograve;ng c&aacute;ch ly 100W, 150W hoặc 200W.</li>
  ...
  {
    id: 10,
    titleVi: "Đèn pha xoay",
    slugVi: "den-pha-xoay",
    titleEn: "Rotating Light",
...
<li>Nguồn điện 1 pha 220 VAC 50Hz</li>
  ...
  {
    id: 11,
    titleVi: "Đèn cao không LED cấu trúc kép",
    slugVi: "den-cao-khong-led-cau-truc-kep",
    titleEn: "Double Obstruction Light",
...
<li>Ti&ecirc;u chuẩn TCVN 7699-2-30:2007</li>
  ...
  {
    id: 12,
    titleVi: "Shelter Thép",
    slugVi: "shelter-thep",
    titleEn: "Steel Shelter",
...
<li>M&aacute;i shelter được chế tạo bằng vật liệu Composite, m&aacute;i dốc tho&aacute;t nước tốt, giảm khả năng đ&oacute;ng tuyết tr&ecirc;n m&aacute;i v&agrave; bền vững, chống thấm nước trong mọi điều kiện thời tiết khắc nghiệt.</li>
    ...
    status: 1,
    productCategoryId: 3,
    productCategorytitleVi: "Shelter",
    productCategorytitleEn: "Shelter",
  ...
  {
    id: 13,
    titleVi: "Shelter Composite",
    slugVi: "shelter-composite",
    titleEn: "Composite Shelter",
  ...
  {
    id: 14,
    titleVi: "Technical console",
    slugVi: "technical-console",
    titleEn: "Technical console",
...
<p>B&agrave;n Console được thiết kế, lắp đặt ph&ugrave; hợp với kh&ocirc;ng gian của đ&agrave;i kiểm so&aacute;t kh&ocirc;ng lưu để người kiểm so&aacute;t vi&ecirc;n c&oacute; thể dễ d&agrave;ng truy cập sử dụng c&aacute;c thiết bị v&agrave; đảm bảo c&oacute; g&oacute;c nh&igrave;n, tầm nh&igrave;n tối ưu trong to&agrave;n bộ qu&aacute; tr&igrave;nh điều h&agrave;nh hoạt động bay.</p>`,
    ...
    status: 1,
    productCategoryId: 4,
    productCategorytitleVi: "Bàn console",
    productCategorytitleEn: "Console Desk",
  ...
  {
    id: 15,
    titleVi: "Giàn phản xạ thép",
    slugVi: "gian-phan-xa-thep",
    titleEn: "Steel Counterpoise",
...
<li>Điện trở tiếp đất của gi&agrave;n: &lt;5 Ohms.</li>
    ...
    status: 1,
    productCategoryId: 5,
    productCategorytitleVi: "Giàn phản xạ",
    productCategorytitleEn: "Counterpoise",
  ...
  {
    id: 16,
    titleVi: "Thiết bị ghi âm chuyên dụng",
    slugVi: "ghi-am-chuyen-dung",
    titleEn: "Specialized Audio Recorder",
...
<li>Đồng bộ thời gian theo chuẩn IRIG-B/ RS-232</li>
    ...
    status: 1,
    productCategoryId: 6,
    productCategorytitleVi: "Thiết bị ghi âm/ ghi hình",
    productCategorytitleEn: "Recording/video equipment",
  ...
  {
    id: 17,
    titleVi: "Thiết bị ghi thoại dữ liệu",
    slugVi: "ghi-thoai-du-lieu",
    titleEn: "Data voice recorder",
...
<li>EUROCAE ED-111 về &ldquo;C&aacute;c đặc t&iacute;nh chức năng cho ghi &acirc;m mặt đất CNS/ATM&rdquo;.</li>
  ...
  {
    id: 18,
    titleVi: "Đồng hồ thời gian chuẩn GPS",
  ...
  },
  {
    ...
    status: 1,
    productCategoryId: 7,
    productCategorytitleVi: "Thiết bị dân dụng khác",
    productCategorytitleEn: "Other Equipment",
  ...
  {
    id: 23,
    titleVi: "Máy hàn quay",
    slugVi: "may-han-quay",
    titleEn: "Rotary welding machine",

...
const ProductCreationForm = ({
  ...
  const [formData, setFormData] = useState({
    titleVi: editingProduct?.titleVi || "",
    ...
    isOutstanding: editingProduct?.isOutstanding || false,
    status: editingProduct?.status ?? 1,
    timePosted: editingProduct?.timePosted
      ? editingProduct.timePosted.split("T")[0]
  ...
  const validateForm = () => {
    ...
    if (!formData.productCategoryId) {
      newErrors.productCategoryId = "Danh mục là bắt buộc";
    }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.log("💾 Saving product with new flow...", { isEditMode });
      console.log("📤 Data gửi lên BE:", JSON.stringify(productData, null, 2));
      ...
      if (response.data?.status === 1 && response.data?.data?.id) {
        ...
        await processEntityAttachments(contentOnlyData, "Product", productId);
        ...
        setToast({
          show: true,
          message: `${isEditMode ? "Cập nhật" : "Lưu"} sản phẩm thành công!`,
          type: "success",
        });
    ...
    <div className="product-creation-form">
      ...
      <div className="form-content">
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <Editor
                key={`content-vi-${editingProduct?.id || "new"}`}
            ...
            <div className="form-group">
              ...
              <div style={{ position: "relative" }}>
                <Editor
                  key={`content-en-${editingProduct?.id || "new"}`}
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <select
                ...
                className={errors.productCategoryId ? "error" : ""}
              >
              ...
              {errors.productCategoryId && (
                <span className="error-text">{errors.productCategoryId}</span>
              )}
            </div>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            <label>Tải lên ảnh cho sản phẩm</label>
            <div className="file-upload-area">
              <input
                type="file"
                multiple
